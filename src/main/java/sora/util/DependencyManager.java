...
public class DependencyManager {
    ...
    private static final String UTILITY_DIR = "database/utility";
    ...
    public static void initializeDependencies() throws DatabaseException {
        try {
            ...
            String corruptPath = BootstrapConfig.CORRUPTPATH;
            String logPath     = BootstrapConfig.LOGPATH;
            String dumpPath    = BootstrapConfig.DUMPPATH;
            String networkPath = BootstrapConfig.NETWORKPATH;
            String utilityPath = BootstrapConfig.UTILITYPATH;

            ensureDirectory(corruptPath);
            ensureDirectory(networkPath);
            ensureDirectory(utilityPath);
