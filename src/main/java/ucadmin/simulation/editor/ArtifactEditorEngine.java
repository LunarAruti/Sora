...
public final class ArtifactEditorEngine {
    ...
    public synchronized boolean run() {
        ...
        inputThread = new Thread(withCrashBoundary(inputController, "input"), "UC-ArtifactEditorInput");
        renderThread = new Thread(withCrashBoundary(() -> renderLoop(window), "render"), "UC-ArtifactEditorRender");
