...
public final class SimulationEngine {
    ...
    public synchronized boolean run() {
        ...
        inputThread = new Thread(withCrashBoundary(inputController, "input"), "UC-SimulationInput");
        renderThread = new Thread(withCrashBoundary(() -> renderLoop(inputController), "render"), "UC-SimulationRender");
